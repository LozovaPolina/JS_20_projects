...
function tellMe(joke) {
    VoiceRSS.speech({
        key: "78f975e7f01e4042b2ca1c47b66849f9",
        src: joke,
        hl: "en-us",
        v: "Linda",
        r: 0,
...
btn.addEventListener('click', () => getJokes('https://v2.jokeapi.dev/joke/Programming?blacklistFlags=nsfw,religious,political,racist,sexist,explicit&type=single'));
